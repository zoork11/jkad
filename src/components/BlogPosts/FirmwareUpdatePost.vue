    ...
    <v-row justify="center">
      <v-card color="transparent" max-width="1000" width="100%">
        ...
        <v-card-text>
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/flash_content.png"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/revisions.png"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/flash1.png"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/flash2.png"></v-img>
          </v-row>
          </p>
          <p class="text-h5">
          Going deeper
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/firmware_update.png"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/stepping.png"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/dafuq.gif"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/flash_layout.png"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
          ...
          <p>
          <v-row justify="center">
          <v-img justify="center" max-width="500px" width="100%" src="../../assets/magic.png"></v-img>
          </v-row>
          </p>
          <p class="text-body-1">
